...
<div class="note">
  ...
  <span class="note-text">
    *Note:* Not pictured on the Power Supply Interface PCB are two green terminal blocks.  Make sure to *remove* these from the PCB before installing the Power Supply End Cap in future steps.
  </span>
</div>
...
<div class="note">
  <i class="fa fa-hand-o-right"></i>
  <span class="note-text">
    *Note:* Skip this step if you did not order limit switches and/or PWM spindle control
  </span>
</div>
...
| 30457-05 | Male Header Connector Right Angle 1 x 40 Pins | 1 |
...
The gShield is marked "X," "Y," and "Z." Wire the stepper cable according to the markings on the shield and order your wires (from left to right) %{color:black}**black**%, %{color:green}**green**%, **white**,  %{color:red}**red**%.
...
<div class="note">
  <i class="fa fa-hand-o-right"></i>
  <span class="note-text">
    *Note:* Nylon spacers are not required to mount the Arduino to the enclosure.
  </span>
</div>
...
<div class="note">
  <i class="fa fa-hand-o-right"></i>
  <span class="note-text">
    *Note:* Skip this step if you did not order the 24V spindle
  </span>
</div>
...
<div class="note">
  <i class="fa fa-hand-o-right"></i>
  <span class="note-text">
    *Note:* Skip this step if you'll be controlling your spindle manually.
  </span>
</div>
