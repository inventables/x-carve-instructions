...
p=(note). Note: Your 24V Power Supply has a toggle switch for input voltage on the side. Use a small flat-blade screwdriver to switch it to the voltage that corresponds to your outlet voltage
...
p=(note). Skip this step if you did not order limit switches and/or PWM spindle control
...
p=(note). (Skip this step if you did not order the 24V spindle)
...
p=(note). Skip this step if you'll be controlling your spindle manually.
