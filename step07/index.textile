...
Use two thread forming screws to attach the Z-Plate to the Z-Axis Makerslide. The screws go through the Z-Plate and into the Makerslide. Be sure to keep constant pressure along the hole you're tapping.
...
<div class="note">
  <i class="fa fa-hand-o-right"></i>
  <span class="note-text">
    Note: It does not matter if the groove is on the right or left side, as long as it is facing up like the picture.
  </span>
</div>
