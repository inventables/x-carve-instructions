...
<div class="note">
  <i class="fa fa-hand-o-right"></i>
  <span class="note-text">
    *Note:* The current version of the Nema 23 Stepper Motor Kits do not have wires attached.  The wires come separately and plug directly into the connector on the stepper motor body.  The current motors also have a flat side on the motor shaft, which provides a more secure installation of the pulley.
  </span>
</div>
