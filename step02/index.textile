...
---
<iframe width="560" height="315" src="https://www.youtube.com/embed/Pts70Si3aTI" frameborder="0" allowfullscreen></iframe>
...
You may have received stepper motors with white connectors on them. Plug the provided four wire connectors in to the motors and follow the rest of the instructions. 

<div class="note">
  <i class="fa fa-hand-o-right"></i>
  <span>
    Note: Note: the connectors only go together one way, be sure to line up the tabs on the wire side to the slots on the motor side.
  </span>
</div>
