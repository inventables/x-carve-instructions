  ...
  <div class="panel panel-default">
    ...
    <div id="dewalt-611" class="panel-collapse collapse" role="tabpanel" aria-labelledby="dewalt-611-header">
      <div class="panel-body">
        ...
        <h3>Mounting Dewalt DWP611</h3>

        To mount your Dewalt DWP611 router follow steps 1 and 2 for the 24V spindle mount, but use 16mm M5 Button Head Cap Screws to attach the mount to the Delrin Nut.
